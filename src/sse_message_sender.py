"""Handles sending messages via SSE streaming."""
...
class SSEMessageSender:
    ...
    def __init__(self, response_queue: asyncio.Queue[Dict[str, Any]]):
    ...
    async def send_image(self, image_path: str) -> None:
        ...
        try:
            if os.path.exists(image_path):
                ...
                await self.send_text(f"Image was generated but file not found: {image_path}")
        except Exception as e:
